...
import { Compass, Star, BookOpen, Calendar, Navigation2, Calculator, GraduationCap, Users, Circle, Brain, Sparkles, Library, Moon } from 'lucide-react'
...
const EXPLORE_ITEMS = [
  ...
  { icon: Moon, label: 'Ramadan', description: 'Blessed Month Hub', href: '/ramadan', color: 'from-violet-500/20 to-purple-600/10', iconColor: 'text-violet-400' },
]
