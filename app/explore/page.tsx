  ...
  return (
    <div className="min-h-screen bg-background pb-nav">
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        {/* ── Search bar (Sticky) ── */}
        <div className="sticky top-[max(0.75rem,calc(env(safe-area-inset-top)+0.75rem))] z-50 -mx-4 px-4 pb-3 bg-background/95 backdrop-blur-xl border-b border-border/30">
