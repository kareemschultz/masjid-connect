...
const ADHKAR_SETS: AdhkarSet[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        transliteration: 'Allahumma inni asbahtu ushhiduka wa ushhidu hamalata arshika wa malaikataka wa jami’a khalqika annaka antal-lah la ilaha illa ant wahdaka la sharika lak wa anna Muhammadan abduka wa rasuluk',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        transliteration: 'Allahumma inni amsaytu ushhiduka wa ushhidu hamalata arshika wa malaikataka wa jami’a khalqika annaka antal-lah la ilaha illa ant wahdaka la sharika lak wa anna Muhammadan abduka wa rasuluk',
  ...
  },
  {
    ...
    items: [
      ...
      {
        arabic: 'بِسْمِ اللَّهِ، بِسْمِ اللَّهِ، بِسْمِ اللَّهِ. أَعُوذُ بِاللَّهِ وَقُدْرَتِهِ مِنْ شَرِّ مَا أَجِدُ وَأُحَاذِرُ',
        transliteration: 'Bismillah, Bismillah, Bismillah. A’udhu billahi wa qudratihi min sharri ma ajidu wa uhadhir',
