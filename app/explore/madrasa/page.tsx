      ...
      <div data-tour="madrasa-cards" className="space-y-3 px-4 pt-5 animate-stagger">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-teal-500/30 bg-teal-500/5 p-5 transition-transform active:scale-[0.98]">
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-base font-bold text-foreground">Noorani Qaida</h3>
                <p className="mt-1 text-xs text-muted-foreground">Learn Arabic Letters &amp; Tajweed Rules</p>
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-0.5">
                <h3 className="text-base font-bold text-foreground">Learn to Pray</h3>
                <span className="rounded-full bg-purple-500/20 px-2 py-0.5 text-[10px] font-semibold text-purple-400">NEW</span>
              </div>
              <p className="text-xs text-muted-foreground">Wudu steps + complete Salah guide with Arabic, transliteration & prayer position icons</p>
        ...
        <Link href="/explore/fiqh" className="relative block overflow-hidden rounded-2xl border border-violet-500/30 bg-violet-500/5 p-5 active:bg-violet-500/10 transition-colors">
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-0.5">
                <h3 className="text-base font-bold text-foreground">Fiqh Guide</h3>
                <span className="rounded-full bg-violet-500/20 px-2 py-0.5 text-[10px] font-semibold text-violet-400">NEW</span>
              </div>
              <p className="text-xs text-muted-foreground">Islamic rulings: Tahara, Salah, Sawm, Nikah, Common Q&amp;A — Hanafi primary</p>
        ...
        {/* ── GII Islamic Library ──────────────────────────────────────── */}
        <Link href="/explore/madrasa/library" className="relative block overflow-hidden rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-5 active:bg-emerald-500/10 transition-colors">
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-0.5">
                <h3 className="text-base font-bold text-foreground">GII Islamic Library</h3>
                <span className="rounded-full bg-emerald-500/20 px-2 py-0.5 text-[10px] font-semibold text-emerald-400">NEW</span>
              </div>
              <p className="text-xs text-muted-foreground">Islamic books from Guyana Islamic Institute — read in-app &amp; download. Aqeedah, Seerah, Fiqh &amp; more.</p>
        ...
        <div className="pt-2 pb-1">
          <h2 className="text-xs font-bold uppercase tracking-widest text-muted-foreground/80">Also in Madrasa</h2>
        </div>

        {/* ── Linked modules (Five Pillars, Articles of Faith) ────────── */}
        {LINKED_MODULES.map((mod) => (
          <Link key={mod.href} href={mod.href} className="flex items-center gap-4 rounded-2xl border border-border bg-card p-4 transition-all active:bg-secondary">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-[10px] text-muted-foreground/80">{mod.lessons} lessons</p>
            </div>
