...
import { GraduationCap, BookOpen, Star, Moon, Heart, Users, Lock } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#0a0b14] pb-24">
      ...
      <div className="space-y-3 px-4 pt-5 animate-stagger">
        ...
        {/* ── Learn to Pray — coming soon ─────────────────────────────── */}
        <div className="relative overflow-hidden rounded-2xl border border-purple-500/30 bg-purple-500/5 p-5 opacity-80">
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-xs text-gray-400">
                Step-by-step Salah guide with audio
              </p>
