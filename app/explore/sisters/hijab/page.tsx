    ...
    <div className="min-h-screen bg-background pb-nav">
      ...
      <div className="space-y-4 px-4 pt-5 animate-stagger">
        ...
        <div className="rounded-2xl border border-border bg-card/50 p-5 space-y-4">
          <h2 className="text-base font-bold text-foreground">What is Hijab?</h2>
        ...
        {/* Styles of Hijab */}
        <div className="rounded-2xl border border-border bg-card/50 p-5 space-y-4">
          <h2 className="text-base font-bold text-foreground">Styles of Hijab</h2>
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                <span className="font-semibold text-foreground">Simple Hijab</span> — A square or rectangular scarf draped over the head and pinned. The most common and versatile style.
              </p>
            </div>
            <div className="flex gap-3">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                <span className="font-semibold text-foreground">Al-Amira</span> — A two-piece style with a fitted cap and matching tube scarf. Easy to wear, stays in place.
              </p>
            </div>
            <div className="flex gap-3">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                <span className="font-semibold text-foreground">Wrap Style</span> — A long rectangular scarf wrapped around the head. Popular for its elegant appearance.
              </p>
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-4">
          <p className="text-sm font-semibold text-foreground">For New Muslims</p>
