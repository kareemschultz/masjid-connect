      ...
      <div className="px-4 pt-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-amber-800/30 bg-amber-950/20 p-4 text-center">
            ...
            <p className="mt-0.5 text-[10px] text-gray-500">2026 — Darul Uloom</p>
          </div>
          <div className="rounded-2xl border border-emerald-800/30 bg-emerald-950/20 p-4 text-center">
            ...
            <p className="mt-0.5 text-[10px] text-gray-500">per person — 2026</p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-gray-800 bg-gray-900 overflow-hidden">
          ...
          <div className="p-5 space-y-4 text-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-white">Old Age / Chronic Illness (no recovery expected)</p>
                <p className="text-gray-400 text-xs mt-1">If genuinely unable to fast and there is no hope of recovery, pay Fidya for each fast missed. No Qadha is required.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <AlertCircle className="h-4 w-4 text-orange-400 mt-0.5 shrink-0" />
              <div>
                <p className="font-semibold text-white">Illness (expected to recover)</p>
                <p className="text-gray-400 text-xs mt-1">Must make Qadha (make-up fasts) when recovered. Fidya is NOT sufficient. If able, make Qadha during winter when days are shorter.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <AlertCircle className="h-4 w-4 text-rose-400 mt-0.5 shrink-0" />
              <div>
                <p className="font-semibold text-white">Pregnant / Breastfeeding Women</p>
                <p className="text-gray-400 text-xs mt-1">Exempt only if fasting is harmful to the child. Must make Qadha later — NOT Fidya. Fidya is only for those who permanently cannot fast.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Sadaqatul Fitr */}
        <div className="rounded-2xl border border-emerald-800/30 bg-gray-900 p-5">
          ...
          <div className="space-y-2.5 text-sm text-gray-300">
            <div className="flex items-center justify-between py-2 border-b border-gray-800">
              <span className="text-gray-400">Amount per person (2026)</span>
