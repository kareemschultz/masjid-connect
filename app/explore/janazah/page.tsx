...
const SECTIONS: JanazahSection[] = [
  {
    ...
    content: (
      <ul className="space-y-2">
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
    ...
    content: (
      <div className="space-y-3">
        <div className="rounded-lg bg-violet-500/10 border border-violet-500/20 px-2.5 py-1.5 inline-block">
          ...
          <p className="text-[10px] text-gray-400">Community obligation — if some fulfil it, the rest are absolved</p>
        </div>
        <ul className="space-y-2">
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          ...
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">Minimum:</strong> wash the entire body once</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">Sunnah:</strong> wash 3, 5, or 7 times (odd number)</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          ...
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">Women:</strong> hair braided into 3 braids, placed behind the back</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          ...
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">Hanafi:</strong> ghusl is obligatory; martyrs (shaheed) are NOT washed</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
  ...
  },
  {
    ...
    content: (
      <ul className="space-y-2">
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          <span><strong className="text-white">Men — 3 white sheets:</strong> Lifafah (outer sheet), Izar (lower body), Qamis (upper body)</span>
        </li>
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          <span><strong className="text-white">Women — 5 pieces:</strong> Lifafah, Izar, Qamis, Khimar (head covering), Khirqa (chest wrap)</span>
        </li>
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
        ...
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          <span><strong className="text-white">Sunnah:</strong> scent the kafan with incense (oud/bakhoor)</span>
        </li>
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <div className="rounded-lg bg-violet-500/10 border border-violet-500/20 px-2.5 py-1.5 inline-block">
          <p className="text-[10px] font-bold text-violet-400">Fard Kifayah</p>
          <p className="text-[10px] text-gray-400">Community obligation</p>
        </div>
        <ul className="space-y-2">
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">4 Takbeers</strong> (Allahu Akbar) — no ruku or sujood</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">After 1st Takbeer:</strong> recite Surah Al-Fatihah</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">After 2nd Takbeer:</strong> recite Salawat (Durood Ibrahim — the one recited in tashahud)</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">After 3rd Takbeer:</strong> dua for the deceased (see next section)</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">After 4th Takbeer:</strong> make Salaam on both sides</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">Imam stands:</strong> at chest level for men, at hip level for women (Hanafi position)</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">For Adults</p>
        ...
        <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">For a Child</p>
  ...
  },
  {
    ...
    content: (
      <ul className="space-y-2">
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          <span><strong className="text-white">Bury as soon as possible</strong> — do not delay unnecessarily</span>
        </li>
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          <span><strong className="text-white">Grave depth:</strong> sufficient to prevent smell and animals</span>
        </li>
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          <span><strong className="text-white">Lahd</strong> (niche on the Qibla side) preferred; <strong className="text-white">Shaq</strong> (straight trench) allowed in necessity</span>
        </li>
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
        ...
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          <span><strong className="text-white">Sunnah:</strong> 3 handfuls of dirt thrown by each person</span>
        </li>
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
        ...
        <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
          <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
          <span><strong className="text-white">Not permissible:</strong> elaborate tombstones, building structures over graves, planting flowers (Hanafi: makruh; other madhhabs: prohibited)</span>
        </li>
      </ul>
    ),
  },
    ...
    content: (
      <div className="space-y-3">
        <ul className="space-y-2">
          ...
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">Talqin</strong> (Hanafi: permissible) — remind the deceased of their testimony of faith while at graveside</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span>Express condolences (<strong className="text-white">Ta&apos;ziyah</strong>) to the family: 3 days maximum</span>
          </li>
          <li className="flex gap-2 text-xs text-gray-300 leading-relaxed">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-gray-600" />
            <span><strong className="text-white">Preparing food for the bereaved family</strong> — NOT the family preparing food for visitors (that is from Jahiliyyah)</span>
          </li>
        </ul>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={org.name} className="flex items-center gap-3 rounded-xl border border-gray-800 bg-gray-800/50 px-3 py-3">
