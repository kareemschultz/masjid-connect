    ...
    <div className="min-h-screen bg-[#0a0b14] pb-24">
      ...
      <div className="space-y-4 px-4 pt-5 animate-stagger">
        ...
        <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-6">
          ...
          <p className="mt-4 text-sm italic text-gray-300 text-center">
            Ash-hadu an l&#257; il&#257;ha ill&#257;-ll&#257;hu wa ash-hadu anna Mu&#7717;ammadan ras&#363;lu-ll&#257;h
          </p>
          <p className="mt-3 text-sm text-[#f9fafb] text-center">
        ...
        <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-5 space-y-4">
          <h2 className="text-base font-bold text-[#f9fafb]">What It Means</h2>
        ...
        <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-5 space-y-4">
          <h2 className="text-base font-bold text-[#f9fafb]">How to Take Your Shahada</h2>
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              <p className="text-sm leading-relaxed text-gray-400">
                <span className="font-semibold text-[#f9fafb]">Believe it sincerely in your heart</span> — this is the most important part.
              </p>
            </div>
            <div className="flex gap-3">
              ...
              <p className="text-sm leading-relaxed text-gray-400">
                <span className="font-semibold text-[#f9fafb]">Say the words with intention (niyyah)</span> — in Arabic if possible, though understanding matters most.
              </p>
            </div>
            <div className="flex gap-3">
              ...
              <p className="text-sm leading-relaxed text-gray-400">
                <span className="font-semibold text-[#f9fafb]">It is recommended (not required) to take your Shahada in the presence of witnesses at a masjid.</span> Contact any imam in Georgetown — they will be honoured to assist you.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-5 space-y-4">
          <h2 className="text-base font-bold text-[#f9fafb]">What Changes After Shahada</h2>
          <p className="text-sm leading-relaxed text-gray-400">
          ...
          <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
            ...
            <p className="mt-1 text-xs text-gray-500">— The Prophet &#xFDFA;, Sahih Muslim</p>
          </div>
