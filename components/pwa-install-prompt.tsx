      ...
      <div className="mx-auto max-w-lg rounded-2xl border border-emerald-500/20 bg-gray-900 p-4 shadow-xl shadow-black/40">
        <div className="flex items-start gap-3">
          ...
          <button
            ...
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-gray-500 active:text-gray-300"
            aria-label="Dismiss"
          >
            <X className="h-4 w-4" />
          </button>
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 py-2.5 text-sm font-semibold text-white transition-all active:scale-[0.98] active:bg-emerald-600"
        >
