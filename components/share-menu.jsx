  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="p-1.5 text-gray-400 hover:text-emerald-600 hover:bg-emerald-900/20 rounded-full transition-all"
        aria-label="Share"
      >
      ...
      {open && (
        <div className="absolute right-0 top-8 bg-gray-800 rounded-xl shadow-xl border border-gray-700 p-2 z-50 w-48 animate-fade-in">
          ...
          <a
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm text-gray-200 hover:bg-emerald-900/20 rounded-lg transition-colors"
          ...
          <button
            onClick={handleCopy}
            className="flex items-center gap-2 px-3 py-2 text-sm text-gray-200 hover:bg-emerald-900/20 rounded-lg transition-colors w-full"
          >
