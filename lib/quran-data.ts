...
export const SURAHS: Surah[] = [
  ...
  { number: 51, name: 'الذاريات', englishName: 'Adh-Dhariyat', englishNameTranslation: 'The Winds that Scatter', numberOfAyahs: 60, revelationType: 'Meccan' },
  ...
  { number: 60, name: 'الممتحنة', englishName: 'Al-Mumtahinah', englishNameTranslation: 'The Woman Examined', numberOfAyahs: 13, revelationType: 'Medinan' },
  ...
  { number: 64, name: 'التغابن', englishName: 'At-Taghabun', englishNameTranslation: 'Mutual Loss and Gain', numberOfAyahs: 18, revelationType: 'Medinan' },
  ...
  { number: 81, name: 'التكوير', englishName: 'At-Takwir', englishNameTranslation: 'The Folding Up', numberOfAyahs: 29, revelationType: 'Meccan' },
  ...
  { number: 84, name: 'الإنشقاق', englishName: 'Al-Inshiqaq', englishNameTranslation: 'The Splitting Apart', numberOfAyahs: 25, revelationType: 'Meccan' },
  { number: 85, name: 'البروج', englishName: 'Al-Buruj', englishNameTranslation: 'The Great Stars', numberOfAyahs: 22, revelationType: 'Meccan' },
